...
Provenance: vendored from the structure-roblox-projects skill's
scripts/check_rojo_artifact.py helper on 2026-09-19. Keeping this reviewed copy in
the repository makes release verification independent of a developer's installed
skills while preserving the same stdlib-only inspection behavior.
"""
